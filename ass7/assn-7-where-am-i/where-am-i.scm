...
(define (intersection-points-helper seq fst)
  (if (null? seq) '()
    (append (intersect fst (car seq)) 
      (intersection-points-helper (cdr seq) fst))))

(define (intersection-points seq)
  (if (null? seq) '()
    (append (intersection-points-helper (cdr seq) (car seq))
      (intersection-points (cdr seq)))))

; (display (intersection-points '((1 (0 0)) (1 (1 0)))))(newline)
; (display (intersection-points '((1 (0 0)) (1 (1 0)) (1 (1 1)))))(newline)
...
; distance-product 2
(define (distance-product firstPoint ls)
  (let ((listWithoutFirstPoint (remove firstPoint ls)))
    (apply * (map (lambda (secondPoint) (dist firstPoint secondPoint)) listWithoutFirstPoint))))

; (display (distance-product '(2 0) '((0 0) (2 0) (6 0))))(newline)
; (display (distance-product '(3 3) '((2 5) (7 8) (10 1) (3 2))))(newline)
...
; (display (rate-points '((0 0) (2 0) (6 0))))(newline)
; (display (rate-points '((2 5) (7 8) (10 1) (3 2))))(newline)
...
(define (sort-points points)
  (quicksort points (lambda (firstPoint secondPoint) (< (car firstPoint) (car secondPoint)))))

; (display (sort-points (rate-points '((2 5) (7 8) (10 1) (3 2)))))(newline)
; (display (sort-points (rate-points '((0 0) (2 0) (6 0)))))(newline)
...
; (display (clumped-points '((0 0) (2 0) (6 0))))(newline)
; (display (clumped-points '((0 0) (2 0) (6 0) (1 0))))(newline)  
...
; average-point 6
(define (average-point-helper list)
  (/ (apply + list) (length list)))

(define (average-point points)
  (let ((avg-pt (list (average-point-helper (map car points))
        (average-point-helper (map cadr points)))))
    (list (distance-product avg-pt points) avg-pt)))

; (display (average-point '((0 0) (2 0) (6 0))))(newline)
; (display (average-point '((0 0) (2 0) (6 0) (1 0) (5 4) (4 5))))(newline)
...
; (display (best-estimate '((1 (0 0)) (1 (2 0)) (0.1 (1 0)))))(newline)
...
; where-am-i 8
(define (where-am-i firstSeq secondSeq)
  (if (or (null? firstSeq) (null? secondSeq)) '()
    (let ((guess (all-guesses firstSeq secondSeq)))
      (sort-points (map best-estimate guess)))))

; (display (where-am-i '(2.5 11.65 7.75) '((0 0) (4 4) (10 0))))(newline)
; (display (where-am-i '(1 2) '((0 0) (3 0))))(newline)
